...
- **Canopy is described by mark, not by light.** Each tree crown is a cluster
  of short curved strokes and stipple flicks radiating from its centre, denser on the lower-right side of every crown, sparser on the upper-left.
...
5. **Is there a clearing or a path?** Something the eye lands on. Reject, every crop must work equally well.
